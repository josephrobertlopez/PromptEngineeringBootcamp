# Participant Materials: Prompt Engineering Bootcamp
...
**Use for**: Client Value Creation or Great Place to Work priorities
...
**Use for**: AI Enablement or Client Value Creation priorities
...
**Use for**: Great Place to Work or Community priorities

---

## Sample Job Descriptions for Interview Prep
...
**Preferred**: MBA, thought leadership, financial services experience
...
**Preferred**: CS/Engineering degree, industry certifications, AI/ML experience
...
**Preferred**: Previous consulting background, retail industry, change management
...
[... complete 325-line prompt continues ...]
```

**Note**: Complete prompt provided as separate file due to length.
...
### Industry Standards
- **Architecture Decision Records**: [github.com/adr/adr-tools](https://github.com/adr/adr-tools)
- **GitHub Copilot Instructions**: [docs.github.com/copilot](https://docs.github.com/en/copilot)
...
- [ ] I generated realistic FY26 priorities using the Priority Builder methodology
...
- [ ] I built complete interview preparation materials using 4-file workflow
...
- [ ] Create spec-kit workflow for a task I do repeatedly  
- [ ] Evaluate new AI tools using the Tier Framework
- [ ] Share Three Approaches framework with my team
...
- Workshop materials: [facilitator email]
- Advanced topics: [facilitator office hours]

**Additional learning:**
- Research papers linked above
- Industry communities and forums
- Follow-up workshops on specialized topics

**Feedback:**
- Workshop improvement suggestions welcome
- Success stories and case studies appreciated
- Advanced topic requests considered
...
├── SESSION-1-FINAL.md           # Session 1 slides
├── SESSION-2-FINAL.md           # Session 2 slides  
├── facilitator-guide.md         # Instructor notes
├── participant-materials.md     # This document
├── priority-builder-prompt.txt  # Complete 325-line prompt
├── demo-personas.md            # Safe practice scenarios
├── interview-prep-templates/   # 4-file workflow templates
├── three-approaches-examples/  # ADR + Config + Tool samples
└── spring-migration-demo/      # Java demonstration files
```

Keep these materials for future reference and ongoing application!
